...
final class SearchImagesCreativeTest extends TestCase
{
    public function testSearchImagesCreativeWithPhrase()
    {
        ...
        $this->assertStringContainsString("search/images/creative", $curlerMock->options[CURLOPT_URL]);
    ...
    public function testSearchImagesCreativeWithCustomParameter()
    {
        ...
        $this->assertStringContainsString("search/images/creative", $curlerMock->options[CURLOPT_URL]);
        $this->assertStringContainsString("phrase=cat", $curlerMock->options[CURLOPT_URL]);
        $this->assertStringContainsString("safe_search=true", $curlerMock->options[CURLOPT_URL]);
    }
